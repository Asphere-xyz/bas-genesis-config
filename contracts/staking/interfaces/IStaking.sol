...
interface IStakingValidatorRegistry is IStakingEvents {
    ...
    function registerValidator(address validator, bytes calldata votingKey, uint16 commissionRate, uint256 initialStake) payable external;
    ...
    function distributeRewards(address validatorAddress, uint256 amount) external payable;
