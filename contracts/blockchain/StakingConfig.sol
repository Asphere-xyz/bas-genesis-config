...
import "../staking/AbstractStakingConfig.sol";
import "../InjectorContextHolder.sol";

contract StakingConfig is InjectorContextHolder, AbstractStakingConfig {

    constructor(ConstructorArguments memory constructorArgs) InjectorContextHolder(constructorArgs) AbstractStakingConfig(address(_GOVERNANCE_CONTRACT)) {
    }
